  ...
  <main>
    <section class="login-container">
      ...
      <div class="card text-center login-card">
        <div class="card-body">
          <h5 class="card-title"><img class="title-logo" src="https://cdn.chatglobal.ml/assets/logo.png" alt="Logo">Chat Global Login</h5>
          <br>
          <form id="login" action="">
            <div class="control-group">
              <input type="email" name="email" class="login-field" value="" placeholder="Email" id="login-email">
            </div>
            <div class="control-group">
            ...
            <a class="register-link" href="/register">¿Sin una cuenta? Registrarse</a>
          </form>
        </div>
      </div>
    </section>
